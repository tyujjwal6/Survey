            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Zone Add Zone</p>
                    </div>
                ...
                <div className="flex items-center text-sm text-gray-500 mb-6">
                    ...
                    <span className="text-brand-secondary">Zone</span>
                    <ChevronRight className="h-4 w-4 mx-1" />
                    <span className="text-gray-700 font-medium">Add Zone</span>
                </div>
                ...
                <Card className="shadow-sm">
                    <CardHeader className="flex flex-row items-center justify-between border-b">
                        <div className="flex items-center">
                            ...
                            <CardTitle className="text-lg font-semibold">Zone</CardTitle>
                        </div>
                        <Button
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="space-y-2">
                                ...
                                <FormRow label="Code" required>
                                    <Input name="code" value={formData.code} onChange={handleInputChange} placeholder="Code" />
                                </FormRow>
                                ...
                                <FormRow label="District" required>
                                    <Select onValueChange={(value) => handleSelectChange('districtId', value)} value={formData.districtId}>
                                        <SelectTrigger><SelectValue placeholder="Select District" /></SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="dist-1">Kamrup</SelectItem>
                                            <SelectItem value="dist-2">Jorhat</SelectItem>
                                        </SelectContent>
                                    </Select>
                                </FormRow>
                            </div>
                            ...
                            <div className="flex justify-start pt-8">
                                ...
                                <Button
                                    type="button"
                                    onClick={handleReset}
                                    className="bg-brand-yellow text-white hover:bg-brand-yellow-dark flex items-center"
                                >
